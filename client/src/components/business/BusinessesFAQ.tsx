    ...
    <div className="border-b border-indigo-100">
      ...
      >
        ...
        <span
          aria-hidden
          className={cn(
            "flex size-8 shrink-0 items-center justify-center rounded-full border border-indigo-200 text-indigo-800 transition-transform duration-200",
            open && "rotate-180 bg-indigo-100",
          )}
        >
...
/** FAQ accordion — ref-style chevron toggles. */
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <Reveal className="lg:col-span-5">
            <h2 className="text-[clamp(1.75rem,1.1rem+2.4vw,2.75rem)] font-semibold leading-[1.12] text-indigo-800">
              {BUSINESSES_FAQ.title}
            </h2>
          </Reveal>

          <div className="lg:col-span-7">
            <div className="border-t border-indigo-100">
              {BUSINESSES_FAQ.items.map((item, i) => (
